                ...
                <div class="container">
                    <div class="col-md-12">
                        <div class="inside">
                            ...
                            <div class="data">
                                <h5><a href="#">Salt Lake Chats</a></h5>
            ...
            <div class="content" id="content">
                <div class="container">
                    <div class="col-md-12">
                        ...
                        <div class="message">
                            <img class="avatar-md" src="/images/avatars/user.png" data-toggle="tooltip" data-placement="top" title="Karen joye" alt="avatar">
                            <div class="text-main">
            ...
            <div class="container">
                <div class="col-md-12">
                    <div class="bottom">
                        ...
                        <label>
                            <input type="submit">
                            <span class="btn attach"><i class="ti-location-arrow"></i></span>
                        </label>
                    </div>
                </div>
            </div>
                            ...
                            <div class="inside">
                                <div class="panel">
                                    <div class="participant">
                                        <img class="avatar-xxl" src="/chatt/img/avatars/avatar-female-5.jpg" alt="avatar">
        ...
        <div class="chat" id="chat">
                ...
                <div class="container">
                    <div class="col-md-12">
                        <div class="inside">
                            ...
                            <div class="data">
                                <h5><a href="#">Cooking Oil Chat</a></h5>
                                <span>Inactive</span>
                            </div>
            ...
            <div class="container">
                <div class="col-md-12">
                    <div class="bottom">
                        <form class="text-area">
                            <textarea class="form-control" placeholder="Start typing for reply..." rows="4"></textarea>
                            <div class="add-smiles">
                                <span title="add icon" class="em em-blush"></span>
                            </div>
                            <div class="smiles-bunch">
